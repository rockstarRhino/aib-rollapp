...
import (
	...
	"github.com/AllInBetsCom/aib-rollapp/app"
	"github.com/AllInBetsCom/aib-rollapp/app/params"
...
// NewRootCmd creates a new root aib-rollapp command. It is called once in the main function.
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			if tmos.FileExists(genFile) {
				...
				utils.SetPrefixes(sdkconfig, "aib")
			}
			sdkconfig.Seal()
...
func initRootCmd(
	...
	initCmd.Flags().String(FlagBech32Prefix, "aib", "set bech32 prefix for rollapp, if left blank default value is 'aib'")
