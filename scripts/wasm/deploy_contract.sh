...
ROLLAPP_KEY_NAME_GENESIS="aib-user"
...
$EXECUTABLE tx wasm store ./scripts/bytecode/cw20_base.wasm --from aib-user --gas 5000000 --yes
...
$EXECUTABLE tx wasm instantiate $ICS20_CODE_ID "$INIT_ICS20" --label ics20 --no-admin --from aib-user --gas 50000000 --yes
sleep 2
